...
Сводная панель показывает: «Авто-выгрузка включена» или «выключена», «Последняя публикация» (именно последняя дошедшая до Авито выгрузка, а не просто попытка), «Активны на Авито», «Черновики», «В очереди по датам» и строку «Есть неопубликованные изменения. Они уйдут на Авито только после нажатия "Опубликовать"». У чисел есть подпись, откуда они взяты (наша сверка или отчёт Авито) — если число на странице фида расходится с «Моими объявлениями», смотрите на подпись: это разные источники.

Если Авито перестал забирать ваш фид (ссылку удалили из профиля автозагрузки в кабинете Авито или выключили автозагрузку), панель скажет прямо: «в фиде, но Авито не забирает» — вместо бесконечного «ждут подтверждения». Карточки, ждущие подтверждения дольше суток, помечаются отдельно: это похоже на сбой синхронизации, напишите в поддержку.
...
- активными на Авито;
- «ждут подтверждения Авито»: отправлены в фид, Авито ещё не подтвердил (подтверждение приходит с задержкой, это нормально);
- с отметкой об ошибке последней выгрузки: причина человеческими словами прямо на карточке (например, «нужно пополнить аванс»).

## Журнал публикаций

Вкладка «Журнал» на странице фида — история выгрузок: каждая публикация с датой и честным исходом: «дошла до Авито», «нужно вставить ссылку в кабинете Авито вручную» или «ошибка». У свежих записей видно, что поменялось в фиде; у старых записей такой пометки может не быть. Если выгрузки давно не было, а правки вы делали — смотрите сюда первым делом.
...
После прогона карточка «Статус публикации» показывает честный итог: сколько объявлений опубликовано, сколько заблокировано и главную ошибку прогона; ниже таблица по каждому объявлению («Внешний ID», «ID Avito», «Статус», «Ошибки») с текстами ошибок от самого Авито. Успешные строки (например, «объявление связано по номеру из фида») ошибками не считаются. Частые причины отказов:
