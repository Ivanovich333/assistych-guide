...
- Если автосписание не прошло (например, не хватило средств), повторных попыток не будет: придёт уведомление в кабинете и письмо на почту. Подписка получит статус «Подписка заморожена (не оплачено)». Продлите тариф вручную: нажмите «Подключить» на своём тарифе и оплатите.
...
- «Подписка заморожена (не оплачено)». Автосписание не прошло. Проверьте карту и продлите тариф вручную кнопкой «Подключить»: бот остановлен именно из-за этого.
